...
import copy
import time
from pyreg.global_reg.open3d_sacia import Open3dSacIaRegistration
...
def main():
    """ 
    Register with the FPFH-SAC IA approach implementation of Open3D
    """
    ...
    rigid_reg = Open3dSacIaRegistration(scan, model, 
                                        ConvergenceCriteria(
